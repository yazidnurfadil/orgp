...
const StaticTemplate = (args: TabsProps) => (
  <Tabs aria-label="Tabs example" {...args}>
    <Tab key="world" title="World">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto corrupti quia et quis maxime corporis aut veritatis molestias, saepe doloribus!</p>
    </Tab>
    <Tab key="ny" title="N.Y">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero odio at nihil molestiae fugit dolores unde deserunt delectus. Odio voluptate temporibus non maiores cum accusamus commodi tenetur, perspiciatis eaque iste.</p>
    </Tab>
    ...
    <Tab key="arts" title="Arts">
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repudiandae incidunt, voluptatibus dolores odio impedit sequi ex, rerum, nam quod tempora non cupiditate? Ratione ipsum sit in eaque inventore consectetur non provident dolorem! Aliquid accusantium delectus ipsum impedit, animi fugiat labore eligendi, esse, architecto itaque consequatur quod. Rem provident ea repudiandae?</p>
    </Tab>
    <Tab key="science" title="Science">
      Lorem ipsum dolor sit amet consectetur, adipisicing elit. Error nostrum reiciendis sunt eius, repudiandae nisi, ratione blanditiis reprehenderit sint possimus eligendi recusandae, illum quas.
    </Tab>
  </Tabs>
);
