...
import React, { Key, FormEvent } from "react";
  ...
  return (
    <form
      ...
      onSubmit={(e: FormEvent<HTMLFormElement>) => {
        alert(
          `Submitted value: ${(e.currentTarget.elements.namedItem("favorite-animal") as HTMLInputElement).value}`
        );
        e.preventDefault();
      }}
    >
...
export const WithValidation = {
  ...
  args: {
    ...
    validate: (value: { selectedKey: string }) => {
      if (
